    ...
    <section>
      <Element name="features">
        <div className="container">
          <div className="relative flex md:flex-wrap flex-nowrap border-2 border-s3 rounded-7xl md:overflow-hidden max-md:flex-col feature-after md:gd7 max-md:border-none max-md:rounded-none max-md:gap-3">
            ...
            <ul className="relative flex justify-around flex-grow px-[5%] border-2 border-s3 rounded-7xl max-md:hidden">
              ...
              {details.map(({ id, title, icon }) => (
                <li key={id} className="relative px-4 pt-16 pb-14">
                  ...
                  <h3 className="relative z-2 max-w-36 mx-auto text-center base-small uppercase my-0">
                    {title}
                  </h3>
                </li>
              ))}
